    ...
    return (
        <div className="h-auto w-full flex flex-wrap items-center justify-between px-4 py-4 bg-white">
            ...
            <div className="w-[120px] h-[40px] flex-shrink-0">
                <Image src="/logo.png" alt="Logo" className="w-full h-full object-contain ml-4" />
            ...
            <div className="flex items-center gap-2 w-full max-w-[492px] h-[44px] border rounded-full px-3 mt-4 ml-1 md:mt-0 md:flex-1 md:mr-8">
                <Image src="/search-normal.png" alt="Search" className="w-[20px] h-[20px]" />
                <input
                    type="text"
            ...
            <div className="flex items-center space-x-4 mt-4 md:mt-0">
                <a href="#"><Image src="/like.png" alt="Like" className="w-[36px] h-[36px]" /></a>
              <a href="#"><Image src="/Notification.png" alt="Notification" className="w-[36px] h-[36px]" /></a>
               <a href="#"><Image src="/Settings.png" alt="Settings" className="w-[36px] h-[36px]" /></a>
               <a href='#'><Image src="/dev-ali.jpg" alt="" className='w-[44px] h-44px' /></a>
            </div>
        </div>
    );
}
