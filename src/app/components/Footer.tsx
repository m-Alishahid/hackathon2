...
export default function Footer() {
  return (
    <footer className="relative flex flex-col items-center space-y-6 px-6 w-full bg-gray-50 py-8">
      {/* Top Section */}
      <div className="w-full flex flex-col lg:flex-row items-start justify-between gap-8">
        ...
        <div className="brand flex flex-col space-y-3 w-full lg:w-1/3">
          <h1 className="text-blue-600 text-3xl font-extrabold text-center lg:text-left">MORENT</h1>
        ...
        {/* Links Section */}
        <div className="links flex flex-wrap justify-center lg:justify-end gap-8 w-full lg:w-2/3">
          ...
          <div className="link-group">
            ...
            <ul className="space-y-1 text-sm">
              ...
              <li>
                <Link href="https://www.instagram.com/codecraftali">Instagram</Link>
              </li>
              <li>
                <Link href="https://www.facebook.com/mali24">Facebook</Link>
              </li>
              <li>
      ...
      <div className="w-full flex flex-col lg:flex-row items-center justify-between gap-4">
        <div className="text-sm text-center lg:text-left w-full lg:w-auto">
          <p className="font-medium">&copy; 2022 MORENT. All rights reserved.</p>
        </div>
